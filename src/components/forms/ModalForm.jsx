...
const CollectionCreateForm = Form.create()((props) => {
	...
	return (
		<Modal visible={visible} title="创建新收藏" okText="创建" onCancel={onCancel} onOk={onCreate}>
			<Form layout="vertical">
				...
				<FormItem label="描述">{getFieldDecorator('description')(<Input type="textarea" />)}</FormItem>
