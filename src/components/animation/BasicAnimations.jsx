					...
					{animations.map((v, i) => (
						<Col className="gutter-row" md={6} key={i}>
							<div className="gutter-box">
								<Card className={`${this.state.animated || this.state.animatedOne === i ? 'animated' : ''} ${this.state.animated || this.state.animatedOne === i ? 'infinite' : ''} ${v}`} onMouseEnter={() => this.animatedOne(i)} onMouseLeave={() => this.animatedOneOver()}>
